...
פותח דיאלוג בחירת תיקייה ומעניק לתוסף הרשאת **עיון וקריאה קבועה** בה — בשונה
מ-`ui.pickFolder`, שההרשאה שלו לריצה הנוכחית בלבד ואין בה מנייה. זו התשתית
לרשימת "התיקיות שלי" בדיאלוג פתיחה. בחירה חוזרת של תיקייה שכבר אושרה מחזירה את
אותו `folderToken`.
...
קבצים שכבר נפתחו ממנה שומרים על ה-`token` שלהם; לביטולם יש `fs.revokeFile`.
